...
public:
    ...
    /*declaration public members for the Graph.hpp*/
...
private:
    ...
    /*declaration private variables for the Graph.hpp*/
    unsigned int _seed;
    long int _NSITES;
...
void Random::print_seeds_on_file(){
    ...
    seedsite_str<<_seed;
    nsite_str<<_NSITES;
// const string directory="/net/bake/h/fs/raffaele/SM0goesinSM4real/";
